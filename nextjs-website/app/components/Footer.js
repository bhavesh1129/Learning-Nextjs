            ...
            <section className="relative overflow-hidden bg-white py-3">
                <div className="container relative z-10 mx-auto px-4">
                    <div className="-m-8 flex flex-wrap items-center justify-between">
                        <Link href='/' className="w-auto p-8">
                            <div className="inline-flex items-center">
                                ...
                                <span className="ml-4 text-lg font-bold">NextUI</span>
                            </div>
                        </Link>
                        <div className="w-auto p-8">
                            <ul className="-m-5 flex flex-wrap items-center">
                                <li className="p-5">
                                    <Link className="font-medium text-sm text-gray-600 hover:text-gray-700" href="#">
                                        Privacy Policy
                                    </Link>
                                </li>
                                <li className="p-5">
